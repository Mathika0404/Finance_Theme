...
function updateForm(){
  ...
  document.getElementById("formTitle").innerText =
    isSignup ? "Create Your Finance Account" : "Welcome Back";

  document.getElementById("formSubtitle").innerText =
    isSignup 
    ? "Sign up to manage your income, expenses, and financial goals easily"
    : "Login to track your finances, transactions, and account balance";
